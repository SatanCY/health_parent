...
public class MessageConstant {
    ...
    public static final String QUERY_IMAGE_SUCCESS = "查询图片成功";
    public static final String QUERY_IMAGE_FAIL = "查询图片失败";
    ...
    public static final String QUERY_ORDERSETTING_FAIL = "查询预约设置数据失败";
    public static final String QUERY_ORDERSETTING_SUCCESS = "查询预约设置数据成功";
}